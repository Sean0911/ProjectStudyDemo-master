...
/** 
 * DAO for table "GANK_CONTENT".
*/
public class GankContentDao extends AbstractDao<GankContent, String> {

    public static final String TABLENAME = "GANK_CONTENT";

    /**
     * Properties of entity GankContent.<br/>
    ...
    public GankContentDao(DaoConfig config) {
        super(config);
    }
    
    public GankContentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GANK_CONTENT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GANK_CONTENT\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GankContent entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GankContent entity) {
        stmt.clearBindings();
    ...
    @Override
    public GankContent readEntity(Cursor cursor, int offset) {
        GankContent entity = new GankContent( //
    ...
    @Override
    public void readEntity(Cursor cursor, GankContent entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(GankContent entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(GankContent entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GankContent entity) {
